 ...
 */
public class NumeroaLetraUtils implements Serializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NumeroaLetraUtils.class);

    private NumeroaLetraUtils() {
     ...
     */
    public static String convierteNumeroaLetra(String number)
            throws NumberFormatException {
        return convierteNumeroaLetra(Double.parseDouble(number));
    }
     ...
     */
    public static String convierteNumeroaLetra(double doubleNumber)
            throws NumberFormatException {
